...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  export interface RpcInterface {
    ...
    router: {
       ...
       **/
      getBestRoute: AugmentedRpc<(amount_in: Balance | AnyNumber | Uint8Array, token_in: CurrencyId | AnyNumber | Uint8Array, token_out: CurrencyId | AnyNumber | Uint8Array, at: Option<BlockHash> | null | object | string | Uint8Array) => Observable<ITuple<[CurrencyId, Balance]>>>;
    };
    rpc: {
      /**
