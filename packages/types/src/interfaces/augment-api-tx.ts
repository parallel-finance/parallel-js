...
import type { CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportPreimagesBounded, KerriaRuntimeOpaqueSessionKeys, KerriaRuntimeOriginCaller, KerriaRuntimeProxyType, OrmlVestingVestingSchedule, PalletBridgeBridgeToken, PalletBridgeBridgeType, PalletCrowdloansBonusConfig, PalletCrowdloansChildStorageKind, PalletCrowdloansContributionStrategy, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletLiquidStakingStakingLedger, PalletLiquidStakingUnstakeProvider, PalletLoansMarket, PalletLoansRateModelInterestRateModel, PalletMultisigTimepoint, PalletTraitsUmpRewardDestination, PalletTraitsUmpXcmCall, PalletTraitsUmpXcmWeightFeeMisc, PalletTraitsXcmAssetType, SpWeightsWeightV2Weight, XcmV3MultiLocation, XcmV3Response, XcmV3WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    amm: {
      ...
      updateProtocolFee: AugmentedSubmittable<(protocolFee: Permill | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Permill]>;
    ...
    crowdloans: {
       ...
       **/
      forceClaimFor: AugmentedSubmittable<(dest: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, crowdloan: u32 | AnyNumber | Uint8Array, leaseStart: u32 | AnyNumber | Uint8Array, leaseEnd: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, u32, u32, u32]>;
      /**
      ...
      notificationReceived: AugmentedSubmittable<(queryId: u64 | AnyNumber | Uint8Array, response: XcmV3Response | { Null: any } | { Assets: any } | { ExecutionResult: any } | { Version: any } | { PalletsInfo: any } | { DispatchResult: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, XcmV3Response]>;
      /**
       ...
       **/
      redeemAndLendFor: AugmentedSubmittable<(dest: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, crowdloan: u32 | AnyNumber | Uint8Array, leaseStart: u32 | AnyNumber | Uint8Array, leaseEnd: u32 | AnyNumber | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, u32, u32, u32, Compact<u128>]>;
      /**
       ...
       **/
      updateLeasesBonus: AugmentedSubmittable<(leaseStart: u32 | AnyNumber | Uint8Array, leaseEnd: u32 | AnyNumber | Uint8Array, bonusConfig: PalletCrowdloansBonusConfig | { bonusPerToken?: any; startTime?: any; endTime?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, PalletCrowdloansBonusConfig]>;
      /**
       * Update crowdloans proxy address in relaychain
       **/
       ...
       **/
      updateVault: AugmentedSubmittable<(crowdloan: u32 | AnyNumber | Uint8Array, cap: Option<u128> | null | Uint8Array | u128 | AnyNumber, endBlock: Option<u32> | null | Uint8Array | u32 | AnyNumber, contributionStrategy: Option<PalletCrowdloansContributionStrategy> | null | Uint8Array | PalletCrowdloansContributionStrategy | 'XCM' | 'XCMPROXY' | number) => SubmittableExtrinsic<ApiType>, [u32, Option<u128>, Option<u32>, Option<PalletCrowdloansContributionStrategy>]>;
      /**
    ...
    evmSignatureCall: {
      ...
      withdraw: AugmentedSubmittable<(asset: u32 | AnyNumber | Uint8Array, address: H160 | string | Uint8Array, value: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H160, u128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    liquidStaking: {
       ...
       **/
      fastMatchUnstake: AugmentedSubmittable<(unstakerList: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId32>]>;
      /**
       * Force advance era
       **/
       ...
       **/
      unstake: AugmentedSubmittable<(liquidAmount: Compact<u128> | AnyNumber | Uint8Array, unstakeProvider: PalletLiquidStakingUnstakeProvider | 'RelayChain' | 'Loans' | 'MatchingPool' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, PalletLiquidStakingUnstakeProvider]>;
      /**
       * Update commission rate
       **/
      updateCommissionRate: AugmentedSubmittable<(commissionRate: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
       * Update incentive amount
       **/
      updateIncentive: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>]>;
      /**
    ...
    loans: {
       ...
       * - `cap`: market capacity
       **/
      updateMarket: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, collateralFactor: Option<Permill> | null | Uint8Array | Permill | AnyNumber, liquidationThreshold: Option<Permill> | null | Uint8Array | Permill | AnyNumber, reserveFactor: Option<Permill> | null | Uint8Array | Permill | AnyNumber, closeFactor: Option<Permill> | null | Uint8Array | Permill | AnyNumber, liquidateIncentiveReservedFactor: Option<Permill> | null | Uint8Array | Permill | AnyNumber, liquidateIncentive: Option<u128> | null | Uint8Array | u128 | AnyNumber, supplyCap: Option<u128> | null | Uint8Array | u128 | AnyNumber, borrowCap: Option<u128> | null | Uint8Array | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [u32, Option<Permill>, Option<Permill>, Option<Permill>, Option<Permill>, Option<Permill>, Option<u128>, Option<u128>, Option<u128>]>;
      /**
       ...
       **/
      updateMarketRewardSpeed: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, supplyRewardPerBlock: Option<u128> | null | Uint8Array | u128 | AnyNumber, borrowRewardPerBlock: Option<u128> | null | Uint8Array | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [u32, Option<u128>, Option<u128>]>;
      /**
    ...
    prices: {
       ...
       **/
      setForeignAsset: AugmentedSubmittable<(foreignAssetId: u32 | AnyNumber | Uint8Array, assetId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32]>;
      /**
       * Set emergency price
       **/
    ...
    proxy: {
       ...
       * zero.
       **/
      addProxy: AugmentedSubmittable<(delegate: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, proxyType: KerriaRuntimeProxyType | 'Any' | 'Loans' | 'Staking' | 'Crowdloans' | 'Farming' | 'Streaming' | 'Governance' | 'AMM' | 'EVM' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, KerriaRuntimeProxyType, u32]>;
      /**
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: KerriaRuntimeProxyType | 'Any' | 'Loans' | 'Staking' | 'Crowdloans' | 'Farming' | 'Streaming' | 'Governance' | 'AMM' | 'EVM' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [KerriaRuntimeProxyType, u32, u16]>;
      /**
       ...
       **/
      proxy: AugmentedSubmittable<(real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<KerriaRuntimeProxyType> | null | Uint8Array | KerriaRuntimeProxyType | 'Any' | 'Loans' | 'Staking' | 'Crowdloans' | 'Farming' | 'Streaming' | 'Governance' | 'AMM' | 'EVM' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, Option<KerriaRuntimeProxyType>, Call]>;
      /**
       ...
       * - `call`: The call to be made by the `real` account.
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<KerriaRuntimeProxyType> | null | Uint8Array | KerriaRuntimeProxyType | 'Any' | 'Loans' | 'Staking' | 'Crowdloans' | 'Farming' | 'Streaming' | 'Governance' | 'AMM' | 'EVM' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, MultiAddress, Option<KerriaRuntimeProxyType>, Call]>;
      /**
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: KerriaRuntimeOriginCaller | { system: any } | { Void: any } | { GeneralCouncil: any } | { TechnicalCommittee: any } | { PolkadotXcm: any } | { CumulusXcm: any } | { Ethereum: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [KerriaRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
