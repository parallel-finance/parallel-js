...
export default {
  ...
  /**
   * Lookup28: pallet_multisig::pallet::Event<T>
   **/
  PalletMultisigEvent: {
    _enum: {
      NewMultisig: {
  ...
  /**
   * Lookup29: pallet_multisig::Timepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup32: pallet_assets::pallet::Event<T, I>
   **/
  PalletAssetsEvent: {
    _enum: {
      Created: {
  ...
  /**
   * Lookup53: cumulus_pallet_parachain_system::pallet::Event<T>
   **/
  ...
  /**
   * Lookup108: orml_xcm::module::Event<T>
   **/
  OrmlXcmModuleEvent: {
    _enum: {
      Sent: {
  ...
  /**
   * Lookup109: orml_vesting::module::Event<T>
   **/
  ...
  /**
   * Lookup110: orml_vesting::VestingSchedule<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup111: pallet_loans::pallet::Event<T>
   **/
  PalletLoansEvent: {
    _enum: {
  ...
  /**
   * Lookup112: pallet_loans::types::Market<Balance>
   **/
  PalletLoansMarket: {
  ...
  /**
   * Lookup114: pallet_loans::rate_model::InterestRateModel
   **/
  ...
  /**
   * Lookup115: pallet_loans::rate_model::JumpModel
   **/
  ...
  /**
   * Lookup116: pallet_loans::rate_model::CurveModel
   **/
  PalletLoansRateModelCurveModel: {
    baseRate: 'u128'
  },
  /**
   * Lookup117: pallet_loans::types::MarketState
   **/
  PalletLoansMarketState: {
    _enum: ['Active', 'Pending', 'Supervision']
  },
  /**
   * Lookup118: pallet_prices::pallet::Event<T>
   **/
  PalletPricesEvent: {
    _enum: {
      SetPrice: '(u32,u128)',
  ...
  /**
   * Lookup119: pallet_crowdloans::pallet::Event<T>
   **/
  ...
  /**
   * Lookup120: pallet_crowdloans::types::VaultPhase
   **/
  ...
  /**
   * Lookup124: pallet_liquid_staking::pallet::Event<T>
   **/
  PalletLiquidStakingEvent: {
    _enum: {
      Staked: '(AccountId32,u128)',
      Unstaked: '(AccountId32,u128,u128)',
      Settlement: '(u128,u128,u128)',
      Bonding: '(AccountId32,u128,ParallelPrimitivesUmpRewardDestination)',
      BondingExtra: 'u128',
      Unbonding: 'u128',
      Rebonding: 'u128',
      WithdrawingUnbonded: 'u32',
      Nominating: 'Vec<AccountId32>',
  ...
  /**
   * Lookup126: pallet_nominee_election::pallet::Event<T>
   **/
  PalletNomineeElectionEvent: {
    _enum: {
      ValidatorsUpdated: 'Vec<PalletNomineeElectionValidatorInfo>'
    }
  },
  /**
   * Lookup128: pallet_nominee_election::ValidatorInfo<sp_core::crypto::AccountId32>
   **/
  PalletNomineeElectionValidatorInfo: {
    name: 'Option<Bytes>',
    address: 'AccountId32',
    stakes: 'u128',
    score: 'u128'
  ...
  /**
   * Lookup135: pallet_amm::pallet::Event<T, I>
   **/
  PalletAmmEvent: {
    _enum: {
      LiquidityAdded: '(AccountId32,u32,u32,u128,u128)',
      LiquidityRemoved: '(AccountId32,u32,u32,u128)',
      PoolCreated: '(AccountId32,u32,u32,u32)',
      Traded: '(AccountId32,u32,u32,u128,u128,u128,u128)'
    }
  },
  /**
   * Lookup136: pallet_router::pallet::Event<T, I>
   **/
  PalletRouterEvent: {
    _enum: {
  ...
  /**
   * Lookup139: pallet_emergency_shutdown::pallet::Event<T>
   **/
  ...
  /**
   * Lookup140: pallet_farming::pallet::Event<T, I>
   **/
  PalletFarmingEvent: {
    _enum: {
      PoolAdded: 'u32',
      AssetsDeposited: '(AccountId32,u32)',
      AssetsWithdrew: '(AccountId32,u32)'
    }
  },
  /**
   * Lookup141: pallet_xcm_helper::pallet::Event<T>
   **/
  PalletXcmHelperEvent: {
    _enum: {
      XcmWeightUpdated: 'ParallelPrimitivesUmpXcmWeightMisc',
      XcmFeesUpdated: 'u128'
    }
  },
  /**
   * Lookup142: parallel_primitives::ump::XcmWeightMisc<Weight>
   **/
  ParallelPrimitivesUmpXcmWeightMisc: {
    bondWeight: 'u64',
    bondExtraWeight: 'u64',
    unbondWeight: 'u64',
    rebondWeight: 'u64',
    withdrawUnbondedWeight: 'u64',
    nominateWeight: 'u64',
    contributeWeight: 'u64',
    withdrawWeight: 'u64',
    addMemoWeight: 'u64'
  },
  /**
  ...
  /**
   * Lookup169: pallet_multisig::pallet::Call<T>
   **/
  PalletMultisigCall: {
    _enum: {
  ...
  /**
   * Lookup176: pallet_assets::types::DestroyWitness
   **/
  ...
  /**
   * Lookup226: pallet_scheduler::pallet::Call<T>
   **/
  PalletSchedulerCall: {
    _enum: {
      schedule: {
  ...
  /**
   * Lookup228: frame_support::traits::schedule::MaybeHashed<vanilla_runtime::Call, primitive_types::H256>
   **/
  ...
  /**
   * Lookup229: pallet_preimage::pallet::Call<T>
   **/
  PalletPreimageCall: {
    _enum: {
      note_preimage: {
  ...
  /**
   * Lookup230: cumulus_pallet_parachain_system::pallet::Call<T>
   **/
  ...
  /**
   * Lookup231: cumulus_primitives_parachain_inherent::ParachainInherentData
   **/
  ...
  /**
   * Lookup232: polkadot_primitives::v1::PersistedValidationData<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup234: sp_trie::storage_proof::StorageProof
   **/
  SpTrieStorageProof: {
    trieNodes: 'Vec<Bytes>'
  },
  /**
   * Lookup236: polkadot_core_primitives::InboundDownwardMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup239: polkadot_core_primitives::InboundHrmpMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup242: cumulus_pallet_xcmp_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup243: cumulus_pallet_dmp_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup245: xcm::VersionedXcm<Call>
   **/
  XcmVersionedXcm: {
    _enum: {
      V0: 'XcmV0Xcm',
  ...
  /**
   * Lookup248: xcm::v0::order::Order<Call>
   **/
  XcmV0Order: {
    _enum: {
      Null: 'Null',
  ...
  /**
   * Lookup253: xcm::v1::order::Order<Call>
   **/
  XcmV1Order: {
    _enum: {
      Noop: 'Null',
  ...
  /**
   * Lookup269: cumulus_pallet_xcm::pallet::Call<T>
   **/
  CumulusPalletXcmCall: 'Null',
  /**
   * Lookup270: pallet_authorship::pallet::Call<T>
   **/
  ...
  /**
   * Lookup272: sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>
   **/
  SpRuntimeHeader: {
    parentHash: 'H256',
    number: 'Compact<u32>',
  ...
  /**
   * Lookup273: sp_runtime::traits::BlakeTwo256
   **/
  SpRuntimeBlakeTwo256: 'Null',
  /**
   * Lookup274: pallet_collator_selection::pallet::Call<T>
   **/
  ...
  /**
   * Lookup275: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup276: vanilla_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup279: orml_oracle::module::Call<T, I>
   **/
  ...
  /**
   * Lookup280: orml_xtokens::module::Call<T>
   **/
  ...
  /**
   * Lookup281: xcm::VersionedMultiAsset
   **/
  ...
  /**
   * Lookup282: orml_xcm::module::Call<T>
   **/
  OrmlXcmModuleCall: {
    _enum: {
      send_as_sovereign: {
  ...
  /**
   * Lookup283: orml_vesting::module::Call<T>
   **/
  ...
  /**
   * Lookup285: pallet_loans::pallet::Call<T>
   **/
  PalletLoansCall: {
    _enum: {
      add_market: {
  ...
  /**
   * Lookup286: pallet_prices::pallet::Call<T>
   **/
  PalletPricesCall: {
    _enum: {
      set_price: {
  ...
  /**
   * Lookup287: pallet_crowdloans::pallet::Call<T>
   **/
  ...
  /**
   * Lookup290: pallet_liquid_staking::pallet::Call<T>
   **/
  PalletLiquidStakingCall: {
    _enum: {
      ...
      settlement: {
        bondingAmount: 'Compact<u128>',
        unbondingAmount: 'Compact<u128>',
      },
      bond: {
        amount: 'Compact<u128>',
  ...
  /**
   * Lookup291: pallet_nominee_election::pallet::Call<T>
   **/
  PalletNomineeElectionCall: {
    _enum: {
      set_validators: {
        validators: 'Vec<PalletNomineeElectionValidatorInfo>'
      }
    }
  },
  /**
   * Lookup292: pallet_membership::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup297: pallet_amm::pallet::Call<T, I>
   **/
  PalletAmmCall: {
    _enum: {
      add_liquidity: {
  ...
  /**
   * Lookup299: pallet_router::pallet::Call<T, I>
   **/
  PalletRouterCall: {
    _enum: {
  ...
  /**
   * Lookup300: pallet_currency_adapter::pallet::Call<T>
   **/
  PalletCurrencyAdapterCall: 'Null',
  /**
   * Lookup301: pallet_bridge::pallet::Call<T>
   **/
  PalletBridgeCall: {
    _enum: {
      set_vote_threshold: {
  ...
  /**
   * Lookup302: pallet_bridge::types::BridgeToken
   **/
  ...
  /**
   * Lookup303: pallet_emergency_shutdown::pallet::Call<T>
   **/
  PalletEmergencyShutdownCall: {
    _enum: ['toggle_shutdown_flag']
  },
  /**
   * Lookup304: pallet_farming::pallet::Call<T, I>
   **/
  PalletFarmingCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup308: pallet_xcm_helper::pallet::Call<T>
   **/
  PalletXcmHelperCall: {
    _enum: {
      update_xcm_fees: {
      ...
      update_xcm_weight: {
        xcmWeightMisc: 'ParallelPrimitivesUmpXcmWeightMisc'
      }
    }
  },
  /**
   * Lookup309: vanilla_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup310: frame_system::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup313: pallet_xcm::pallet::Origin
   **/
  PalletXcmOrigin: {
    _enum: {
  ...
  /**
   * Lookup314: cumulus_pallet_xcm::pallet::Origin
   **/
  ...
  /**
   * Lookup318: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup329: pallet_balances::pallet::Error<T, I>
   **/
  PalletBalancesError: {
  ...
  /**
   * Lookup335: pallet_assets::types::AssetAccount<Balance, DepositBalance, Extra>
   **/
  ...
  /**
   * Lookup336: pallet_assets::types::ExistenceReason<Balance>
   **/
  ...
  /**
   * Lookup338: pallet_assets::types::Approval<Balance, DepositBalance>
   **/
  ...
  /**
   * Lookup339: pallet_assets::types::AssetMetadata<DepositBalance, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup341: pallet_assets::pallet::Error<T, I>
   **/
  PalletAssetsError: {
  ...
  /**
   * Lookup344: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32, vanilla_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup377: pallet_democracy::Releases
   **/
  ...
  /**
   * Lookup387: pallet_treasury::pallet::Error<T, I>
   **/
  PalletTreasuryError: {
    _enum: ['InsufficientProposersBalance', 'InvalidIndex', 'TooManyApprovals']
  },
  /**
   * Lookup390: pallet_scheduler::ScheduledV3<frame_support::traits::schedule::MaybeHashed<vanilla_runtime::Call, primitive_types::H256>, BlockNumber, vanilla_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup391: pallet_scheduler::pallet::Error<T>
   **/
  ...
  /**
   * Lookup398: polkadot_primitives::v1::UpgradeRestriction
   **/
  ...
  /**
   * Lookup402: polkadot_primitives::v1::AbridgedHrmpChannel
   **/
  ...
  /**
   * Lookup403: polkadot_primitives::v1::AbridgedHostConfiguration
   **/
  ...
  /**
   * Lookup409: polkadot_core_primitives::OutboundHrmpMessage<polkadot_parachain::primitives::Id>
   **/
  ...
  /**
   * Lookup412: cumulus_pallet_xcmp_queue::InboundChannelDetails
   **/
  ...
  /**
   * Lookup413: cumulus_pallet_xcmp_queue::InboundState
   **/
  CumulusPalletXcmpQueueInboundState: {
    _enum: ['Ok', 'Suspended']
  },
  /**
   * Lookup416: polkadot_parachain::primitives::XcmpMessageFormat
   **/
  PolkadotParachainPrimitivesXcmpMessageFormat: {
    _enum: ['ConcatenatedVersionedXcm', 'ConcatenatedEncodedBlob', 'Signals']
  },
  /**
   * Lookup419: cumulus_pallet_xcmp_queue::OutboundChannelDetails
   **/
  ...
  /**
   * Lookup420: cumulus_pallet_xcmp_queue::OutboundState
   **/
  CumulusPalletXcmpQueueOutboundState: {
    _enum: ['Ok', 'Suspended']
  },
  /**
   * Lookup422: cumulus_pallet_xcmp_queue::QueueConfigData
   **/
  ...
  /**
   * Lookup424: cumulus_pallet_xcmp_queue::pallet::Error<T>
   **/
  CumulusPalletXcmpQueueError: {
    _enum: ['FailedToSend', 'BadXcmOrigin', 'BadXcm', 'BadOverweightIndex', 'WeightOverLimit']
  },
  /**
   * Lookup425: cumulus_pallet_dmp_queue::ConfigData
   **/
  CumulusPalletDmpQueueConfigData: {
    maxIndividual: 'u64'
  },
  /**
   * Lookup426: cumulus_pallet_dmp_queue::PageIndexData
   **/
  ...
  /**
   * Lookup429: cumulus_pallet_dmp_queue::pallet::Error<T>
   **/
  ...
  /**
   * Lookup443: pallet_authorship::UncleEntryItem<BlockNumber, primitive_types::H256, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup444: pallet_authorship::pallet::Error<T>
   **/
  PalletAuthorshipError: {
    _enum: ['InvalidUncleParent', 'UnclesAlreadySet', 'TooManyUncles', 'GenesisUncle', 'TooHighUncle', 'UncleAlreadyIncluded', 'OldUncle']
  },
  /**
   * Lookup446: pallet_collator_selection::pallet::CandidateInfo<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup447: pallet_collator_selection::pallet::Error<T>
   **/
  ...
  /**
   * Lookup457: orml_oracle::module::TimestampedValue<sp_arithmetic::fixed_point::FixedU128, Moment>
   **/
  ...
  /**
   * Lookup458: orml_utilities::ordered_set::OrderedSet<sp_core::crypto::AccountId32, S>
   **/
  OrmlUtilitiesOrderedSet: 'Vec<AccountId32>',
  /**
   * Lookup460: orml_oracle::module::Error<T, I>
   **/
  OrmlOracleModuleError: {
    _enum: ['NoPermission', 'AlreadyFeeded']
  },
  /**
   * Lookup461: orml_xtokens::module::Error<T>
   **/
  ...
  /**
   * Lookup462: orml_xcm::module::Error<T>
   **/
  OrmlXcmModuleError: {
    _enum: ['Unreachable', 'SendFailure', 'BadVersion']
  },
  /**
   * Lookup464: orml_vesting::module::Error<T>
   **/
  OrmlVestingModuleError: {
    _enum: ['ZeroVestingPeriod', 'ZeroVestingPeriodCount', 'InsufficientBalanceToLock', 'TooManyVestingSchedules', 'AmountLow', 'MaxVestingSchedulesExceeded']
  },
  /**
   * Lookup465: pallet_loans::types::BorrowSnapshot<Balance>
   **/
  ...
  /**
   * Lookup466: pallet_loans::types::Deposits<Balance>
   **/
  PalletLoansDeposits: {
    voucherBalance: 'u128',
    isCollateral: 'bool'
  ...
  /**
   * Lookup467: pallet_loans::types::EarnedSnapshot<Balance>
   **/
  ...
  /**
   * Lookup468: pallet_loans::pallet::Error<T>
   **/
  PalletLoansError: {
  ...
  /**
   * Lookup470: pallet_crowdloans::types::Vault<T>
   **/
  ...
  /**
   * Lookup471: pallet_crowdloans::types::XcmRequest<T>
   **/
  ...
  /**
   * Lookup472: pallet_crowdloans::types::Releases
   **/
  PalletCrowdloansReleases: {
    _enum: ['V0_0_0', 'V1_0_0']
  },
  /**
   * Lookup473: pallet_crowdloans::pallet::Error<T>
   **/
  ...
  /**
   * Lookup474: pallet_liquid_staking::types::MatchingLedger<Balance>
   **/
  ...
  /**
   * Lookup478: pallet_liquid_staking::types::XcmRequest<T>
   **/
  ...
  /**
   * Lookup479: pallet_liquid_staking::pallet::Error<T>
   **/
  PalletLiquidStakingError: {
    _enum: ['InvalidExchangeRate', 'StakeTooSmall', 'UnstakeTooSmall', 'InvalidLiquidCurrency', 'InvalidStakingCurrency', 'UnstakeQueueCapExceeded', 'CapExceeded', 'InvalidCap', 'InvalidFactor']
  },
  /**
   * Lookup480: pallet_nominee_election::pallet::Error<T>
   **/
  PalletNomineeElectionError: {
    _enum: ['MaxValidatorsExceeded', 'NoEmptyValidators', 'BadValidatorsFeeder']
  },
  /**
   * Lookup481: pallet_membership::pallet::Error<T, I>
   **/
  PalletMembershipError: {
    _enum: ['AlreadyMember', 'NotMember']
  },
  /**
   * Lookup486: pallet_amm::types::Pool<CurrencyId, Balance, BlockNumber>
   **/
  PalletAmmPool: {
    baseAmount: 'u128',
    quoteAmount: 'u128',
  ...
  /**
   * Lookup487: pallet_amm::pallet::Error<T, I>
   **/
  PalletAmmError: {
    _enum: ['PoolDoesNotExist', 'InsufficientLiquidity', 'NotAnIdealPrice', 'PoolAlreadyExists', 'InsufficientAmountOut', 'InsufficientAmountIn', 'IdenticalAssets', 'LpTokenAlreadyExists']
  },
  /**
   * Lookup488: pallet_router::pallet::Error<T, I>
   **/
  PalletRouterError: {
    _enum: ['ZeroBalance', 'EmptyRoute', 'InsufficientBalance', 'ExceedMaxLengthRoute', 'DuplicatedRoute', 'MaximumAmountInViolated', 'MinimumAmountOutViolated']
  },
  /**
   * Lookup493: pallet_bridge::types::MaterializeCall<T, sp_core::crypto::AccountId32, R>
   **/
  ...
  /**
   * Lookup494: pallet_bridge::types::Proposal<sp_core::crypto::AccountId32, E>
   **/
  ...
  /**
   * Lookup495: pallet_bridge::types::ProposalStatus
   **/
  ...
  /**
   * Lookup497: pallet_farming::pallet::Pool<BlockNumber, AssetId, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  PalletFarmingPool: {
    start: 'u32',
    end: 'u32',
  ...
  /**
   * Lookup498: pallet_farming::pallet::Error<T, I>
   **/
  PalletFarmingError: {
    _enum: ['PoolDoesNotExist', 'PoolAlreadyExists', 'NotANewlyCreatedAsset', 'NotAValidDuration', 'NotAValidAmount', 'SmallerThanEndBlock', 'CodecError']
  },
  /**
   * Lookup499: pallet_xcm_helper::pallet::Error<T>
   **/
  ...
  /**
   * Lookup517: vanilla_runtime::Runtime
   **/
